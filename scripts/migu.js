        ...
        return {
          ...
          artist:
            (_c =
              ...
              : _c.join(", "),
          album:
            (_d = _.album) === null || _d === void 0 ? void 0 : _d.albumName,
          copyrightId: _.copyrightId,
          singerId:
            (_f =
              (_e = _.singers) === null || _e === void 0 ? void 0 : _e[0]) ===
              null || _f === void 0
              ? void 0
              : _f.id,
        };
  ...
  try {
    ...
    if (
      (lastSource === null || lastSource === void 0
        ? void 0
        : lastSource.songId) !== musicItem.id
    ) {
      lastSource = (
        await axios_1.default.get(
    ...
    const artwork =
      musicItem.artwork ||
      (
        ((_a = lastSource.albumImgs) === null || _a === void 0
          ? void 0
          : _a[0]) || {}
      ).img;
    let rateFormats =
      (_b = lastSource.newRateFormats) !== null && _b !== void 0 ? _b : [];
    let url;
    if (quality === "super") {
      url = rateFormats
...
module.exports = {
  ...
  srcUrl:
    "https://raw.githubusercontent.com/Jankinsu/MFPlugins/master/scripts/migu.js",
