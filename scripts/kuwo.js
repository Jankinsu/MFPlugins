...
function musicListFilter(item) {
  var _a;
  return (
    ((_a = item === null || item === void 0 ? void 0 : item.payInfo) === null ||
    _a === void 0
      ? void 0
      : _a.listen_fragment) !== "1"
  );
}
...
module.exports = {
  ...
  srcUrl:
    "https://raw.githubusercontent.com/Jankinsu/MFPlugins/master/scripts/kuwo.js",
  ...
  async getMediaSource(musicItem, quality) {
    ...
    const res = (
      await axios_1.default.get(
        `https://antiserver.kuwo.cn/anti.s?type=convert_url3&rid=${musicItem.id}&format=mp3`
      )
    ).data;
    return {
      url: res.url,
